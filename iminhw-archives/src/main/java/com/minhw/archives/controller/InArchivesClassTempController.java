 ...
 */
@RestController
@RequestMapping("/archives/class_temp")
 ...
 * 查询档案收录缓存列表
 */
@PreAuthorize("@ss.hasPermi('archives:class_temp:list')")
@GetMapping("/list")
     ...
     * 导出档案收录缓存列表
     */
    @PreAuthorize("@ss.hasPermi('archives:class_temp:export')")
     ...
     * 获取档案收录缓存详细信息
     */
    @PreAuthorize("@ss.hasPermi('archives:class_temp:query')")
    @GetMapping(value = "/{id}")
     ...
     * 新增档案收录缓存
     */
    @PreAuthorize("@ss.hasPermi('archives:class_temp:add')")
     ...
     * 修改档案收录缓存
     */
    @PreAuthorize("@ss.hasPermi('archives:class_temp:edit')")
     ...
     * 删除档案收录缓存
     */
    @PreAuthorize("@ss.hasPermi('archives:class_temp:remove')")
