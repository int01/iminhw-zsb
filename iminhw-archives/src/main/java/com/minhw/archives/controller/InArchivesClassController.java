...
@GetMapping("/list")
    ...
    @Log(title = "档案收集情况", businessType = BusinessType.EXPORT)
    @PostMapping("/export")
    public void export(HttpServletResponse response, InArchivesClass inArchivesClass) {
        ...
        util.exportExcel(response, list, "档案收集情况数据");
    }
    ...
    @Log(title = "档案收集情况", businessType = BusinessType.INSERT)
    @PostMapping
    ...
    @Log(title = "档案收集情况", businessType = BusinessType.UPDATE)
    @PutMapping
    ...
    @Log(title = "档案收集情况", businessType = BusinessType.DELETE)
